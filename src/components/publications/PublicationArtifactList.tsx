...
import type { LinkedPublicationArtifact } from "@/data/publicationsLibrary";

type PublicationArtifactListProps = {
  title: string;
  items: readonly LinkedPublicationArtifact[];
  emptyLabel: string;
};

export default function PublicationArtifactList({ title, items, emptyLabel }: PublicationArtifactListProps) {
  return (
